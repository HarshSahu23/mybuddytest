...
class Retainer extends StatefulWidget {
  const Retainer({super.key});

  @override
  State<Retainer> createState() => _RetainerState();
}

class _RetainerState extends State<Retainer> {
  double nowGPA = 0;
  int nowSemCredit = 0;
  double oldCGPA = 0;
      ...
      child: ListView(
        children: [
          Container(
            ...
            padding: EdgeInsets.all(5),
            child: Center(
              child: Text("I want to retain"),
            ),
          ),
          _myInputForCGPA(TEC_nowGPA, "Select CGPA to retain ", context),
          _myInputForCGPA(
